...
var rootCmd = &cobra.Command{
	Use:   "apo",
	Short: "APO - AI-Powered Process Optimizer",
	Long: `APO (AI-Powered Process Optimizer) monitors Linux processes,
uses Anthropic Claude AI for intelligent termination decisions,
and provides an htop-like TUI for interactive management.

Run 'apo interactive' for the full TUI experience, or
'apo monitor' for a simple text-based process view.`,
}
